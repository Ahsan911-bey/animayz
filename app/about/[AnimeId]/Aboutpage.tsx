...
export default function AnimePage() {
    ...
    return(
        ...
        <div>
                <p className="text-gray-400 text-xl ml-8 font-myfont">Overview</p>
                ...
                <p className="text-gray-400 text-xl ml-8 font-myfont">Seasons</p>
                <div className="flex flex-row bg-[#171719] rounded-lg gap-10">
                    <div className="flex flex-col gap-3 ">
                        <div className="ml-6">
                        <h2 className="text-white flex items-center gap-1 text-xl  font-myfont mt-6 mb-4"><IoIosInformationCircleOutline size={20} /> Details</h2>
                ...
                <h2 className="text-white text-3xl font-bold ml-2 mt-2">Characters</h2>
                ...
                <h2 className="text-white text-2xl font-bold ml-2 mt-12">Recommended Animes:</h2>
