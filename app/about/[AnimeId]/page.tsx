                    ...
                    <div className="flex flex-col gap-3 ">
                        <div className="ml-6">
                            ...
                            <ul className="text-gray-400 space-y-2 mb-5">
                                ...
                                <li ><strong className="text-white mr-2">Episodes:</strong>{animeData.totalEpisodes}</li>
                    ...
                    <div className="flex flex-col gap-3 ">
                        <div className="ml-6">
                            ...
                            <ul className="text-gray-400 space-y-2 mb-5">
                                ...
                                <li ><strong className="text-white mr-2">Sub or Dub:</strong>{animeData.subOrDub}</li>
                                <li ><strong className="text-white mr-2">Type:</strong>{animeData.type}</li>
                            </ul>
                        </div>
                    </div>
